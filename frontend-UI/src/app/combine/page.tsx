      ...
      <AppLayout>
        <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-[#F2F2F2]">
          <div className="max-w-2xl w-full">
            <div className="text-center rounded-2xl p-10 shadow-xl border-2 bg-white border-gray-200">
              ...
              <p className="text-lg mb-8 leading-relaxed text-[#666666]">
                {numPlaylists > 1 ? (
                  <>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                  ...
                  className="px-8 py-3 rounded-lg font-semibold transition-all border-2 border-gray-200 text-[#333333] hover:border-[#FF5500]"
                >
              ...
              <div className="bg-white rounded-2xl p-6 border-2 border-gray-200">
                ...
                {loading ? (
                  ...
                  <p className="text-[#666666] py-8 text-center">
                    No playlists found. Create some playlists on SoundCloud
                    first.
                  </p>
                ) : (
              ...
              <div className="bg-white rounded-2xl p-6 border-2 border-gray-200 sticky top-24">
                ...
                <div className="mb-6">
                  ...
                  {selectedPlaylists.length === 0 ? (
                    <p className="text-sm text-[#999999] py-4 text-center border-2 border-dashed border-gray-200 rounded-lg">
                    ...
                    <div className="space-y-2">
                      {selectedPlaylists.map((playlist) => (
                        ...
                        >
                          <span className="text-sm truncate flex-1 text-[#333333]">
                            {playlist.title}
                          </span>
                          <button
                            onClick={() => handlePlaylistToggle(playlist)}
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <div className="text-sm text-[#666666]">Total Tracks</div>
