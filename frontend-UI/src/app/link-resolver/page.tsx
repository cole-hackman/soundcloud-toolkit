          ...
          <div className="bg-white rounded-2xl p-6 border-2 border-gray-200 mb-8">
            <div className="flex gap-4">
              <div className="flex-1 relative">
                <LinkIcon className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#999999]" />
                <input
                  type="text"
                  value={url}
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-lg border-2 border-gray-200 focus:border-[#FF5500] focus:outline-none transition text-lg"
                />
              </div>
              <button
                onClick={resolveLink}
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  {result.description && (
                    <p className="text-[#666666] text-sm line-clamp-3 mb-4">
                      {result.description}
                    </p>
                  )}
                  ...
                  <div className="flex flex-wrap gap-4 mb-4">
                    ...
                    {result.track_count !== undefined && (
                      <div className="px-4 py-2 bg-gray-50 rounded-lg">
                        <div className="text-xs text-[#999999]">Tracks</div>
                        <div className="font-semibold text-[#333333]">
                          {result.track_count}
                        </div>
                      </div>
                    ...
                    {result.followers_count !== undefined && (
                      <div className="px-4 py-2 bg-gray-50 rounded-lg">
                        <div className="text-xs text-[#999999]">Followers</div>
                        <div className="font-semibold text-[#333333]">
              ...
              <details className="mt-8">
                <summary className="cursor-pointer text-sm text-[#666666] hover:text-[#FF5500]">
                  View raw data
                </summary>
